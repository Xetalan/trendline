/* The default training week.
   ...
   `base` is the weight of the attachment itself: the bench bar weighs 5 lb,
   everything else hangs off handles that weigh nothing. Total = base + 2 x
   per-side, which is why the bench reads 205 while a 100-a-side press reads
   200.
  ...
  const TEMPLATES = [
    {
      ...
      name: 'Chest & Triceps',
      exercises: [
        ex('Bench press', 3, 10, 100, { base: 5 }),   // 205 total with the bar
